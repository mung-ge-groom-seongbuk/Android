...
class ChatDataSource @Inject constructor(
    ...
    fun postSendChat(sendChatDTO: SendChatDTO): Flow<BaseResponse<String>> = flow {
    ...
    fun getChatMessage(senderId: String, receiverId: String): Flow<BaseResponse<String>> = flow {
